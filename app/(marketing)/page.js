...
export default function HomePage() {
  return (
    <div id="home">
      ...
      <p>
        UnfoldNews is here to deliver you all the latest news - concise &
        unbiased!
      </p>

      <p>
        .. aims to provide you with the latest news in a concise and unbiased
        manner. We strive to deliver the news in a way that is easy to
